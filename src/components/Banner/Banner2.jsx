        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px]">
            <motion.h1 variants={SlideUp(0.2)} initial="initial" whileInView="animate" className="text-4xl font-bold font-serif">
              Projeck yang telah kami bangun dan kami wujudkan mimpi mereka
            </motion.h1>
            <motion.p variants={SlideUp(0.4)} initial="initial" whileInView="animate" className="text-gray-500 text-sm leading-7">
              Kami selalu mengedepankan impian anda untuk menuju kesuksesan demi generasi indonesia emas{' '}
            </motion.p>
