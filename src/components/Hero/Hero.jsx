        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:min-h-[600px] gap-10">
          ...
          <div className="flex flex-col justify-center gap-7 md:pr-8 xl:pr-10 text-center md:text-left pt-20 md:pt-0 px-10">
            ...
            <div className="space-x-4">
              <motion.button variants={SlideUp(1.1)} initial="initial" animate="animate" className="primary-btn ">
          ...
          <div className="flex flex-col items-center justify-center ">
            <motion.img initial={{ x: 100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.5 }} src={HeroPng} alt="" className="w-[80%] md:w-[700px] object-cover " />
          </div>
        </div>
      </div>
    </>
